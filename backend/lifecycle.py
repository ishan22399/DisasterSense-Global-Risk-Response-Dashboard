...
class LifecycleManager:
    ...
    def transition_to_expired(event: DisasterEvent) -> DisasterEvent:
        ...
        days_since_event = (datetime.utcnow() - event.event_time).days
    ...
    def check_for_expiry(cls, event: DisasterEvent) -> Optional[DisasterEvent]:
        ...
        days_since_event = (now - event.event_time).days
        days_since_update = (now - event.last_updated).days
    ...
    def get_lifecycle_summary(event: DisasterEvent) -> Dict[str, Any]:
        ...
        return {
            ...
            'age_days': (datetime.utcnow() - event.event_time).days,
