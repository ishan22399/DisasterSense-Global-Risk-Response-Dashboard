            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center space-y-3 sm:space-y-0 sm:space-x-4 lg:space-x-6 w-full sm:w-auto">
              ...
              {lastUpdated && (
                <div className="text-xs text-gray-500 dark:text-gray-400 text-right">
                  ...
                  {isRealTimeEnabled && (
                    <div>Next: {new Date(lastAutoRefresh.getTime() + refreshInterval * 1000).toLocaleTimeString()}</div>
                  )}
                </div>
              )}
            </div>
        ...
        {dataFreshness === 'outdated' && (
          <div className="mb-6">
            <Alert className="border-orange-200 bg-orange-50 dark:bg-orange-950">
              ...
              <AlertTitle className="text-orange-800 dark:text-orange-200">Data Outdated</AlertTitle>
              <AlertDescription className="text-orange-700 dark:text-orange-300">
                Disaster data is more than 10 minutes old. Click refresh or enable auto-updates for current information.
              </AlertDescription>
            </Alert>
          </div>
        )}
        ...
        <Tabs value={activeTab} onValueChange={handleTabChange} className="space-y-6">
          ...
          <TabsContent value="overview" className="space-y-4 sm:space-y-6">
            <div className="grid grid-cols-1 xl:grid-cols-2 gap-4 sm:gap-6">
                    ...
                    return (
                      ...
                      >
                        <div className="flex items-center space-x-2 sm:space-x-3 min-w-0 flex-1">
                          ...
                          <div>
                            <p className="font-medium text-sm">{disaster.title}</p>
                            <p className="text-xs text-gray-500">
                              {disaster.affected.toLocaleString()} people affected
                            </p>
                          </div>
                        </div>
              ...
              <Card>
                <CardHeader>
                  <CardTitle>Disaster Breakdown</CardTitle>
                  <CardDescription>Current disasters by type and severity</CardDescription>
                </CardHeader>
